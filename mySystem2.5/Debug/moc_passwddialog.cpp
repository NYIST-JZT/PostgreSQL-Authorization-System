...
#include "../mySystem2.5/passwddialog.h"
...
struct qt_meta_stringdata_PasswdDialog_t {
    QByteArrayData data[3];
    char stringdata0[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PasswdDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PasswdDialog_t qt_meta_stringdata_PasswdDialog = {
    {
QT_MOC_LITERAL(0, 0, 12), // "PasswdDialog"
QT_MOC_LITERAL(1, 13, 15), // "closethisDiolag"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "PasswdDialog\0closethisDiolag\0"
};
...
void PasswdDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closethisDiolag(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject PasswdDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PasswdDialog.data,
      qt_meta_data_PasswdDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *PasswdDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PasswdDialog.stringdata0))
